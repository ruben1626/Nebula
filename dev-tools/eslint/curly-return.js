...
module.exports = function(context) {
	...
	var multiLineExceptReturn = (context.options[0] === 'multi-line-except-return');
    ...
    function prepareCheck(node, body, name, suffix) {
        ...
        } else if (multiLineExceptReturn) {
            if (!isCollapsedOneLiner(body) && (hasBlock || body.type !== 'ReturnStatement')) {
                expected = true;
            }
		} else if (multiLine) {
...
module.exports.schema = {
    "anyOf": [
        ...
        },
        {
            ...
            "items": [
                {
                    "enum": ["multi", "multi-line", "multi-or-nest", "multi-line-except-return"]
                },
                {
                    "enum": ["consistent"]
                }
